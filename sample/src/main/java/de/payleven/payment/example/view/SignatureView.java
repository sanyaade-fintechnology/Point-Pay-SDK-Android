...
import de.payleven.payment.example.payment.OnSignListener;
    ...
    public boolean onTouchEvent(@NonNull MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                //notify signature listener
                //notify signature listener
                if (mSignListener != null) {
                    mSignListener.onSign();
                }
                break;

            default:
                Log.v("SignatureView", "Ignored touch event: " + event.toString());
                return false;
        }
