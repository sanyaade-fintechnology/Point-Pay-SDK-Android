...
public class PaymentProcessor {
    ...
    private void notifyPaymentProgressStateChanged(PaymentProgressState paymentProgressState) {
        if (mView != null) {
            mView.onPaymentProgressStateChanged(paymentProgressState);
        }
    }
    ...
    private class PaymentListenerImpl implements PaymentListener {
        ...
        /**
         * Called when the payment progress state changed. This state is an optional
         * information that might be used for different purposes like displaying
         * different UI animations or notifying the user of the current state.
         */
        @Override
        public void onPaymentProgressStateChanged(PaymentProgressState paymentProgressState) {
            Log.v("OnStateChanged", paymentProgressState.name());
            notifyPaymentProgressStateChanged(paymentProgressState);
        }
